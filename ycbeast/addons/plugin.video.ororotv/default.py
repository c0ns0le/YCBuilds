...
class link:
    def __init__(self):
        ...
        self.movies_link = 'https://ororo.tv/en/movies'
        self.sign_link = 'https://ororo.tv/en/users/sign_in'
        self.cookie = None
...
class seasons:
    ...
    def ororo_list(self, url, image, year, imdb, genre, plot, show):
        try: 
            ...
            seasons = common.parseDOM(result, "ul", attrs = { "class": "ui tabular menu show-content__season-list" })[0]
...
class episodes:
    ...
    def ororo_list(self, name, url, image, year, imdb, genre, plot, show, idx_data):
        try:
            ...
            episodes = common.parseDOM(result, "div", attrs = { "class": "tab-content show-content__episode-list" })[0]
        ...
        for episode in episodes:
            try:
                ...
                num = common.parseDOM(episode, "a", attrs = { "class": "show-content__episode-link js-episode" }, ret=" href")[0]
                ...
                try: desc = common.parseDOM(episode, "div", attrs = { "class": "episode-plot__text" })[0]
                except: desc = plot

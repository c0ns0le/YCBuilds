...
def wizard(name,url,description):
    ...
    dp.create("YCBeast Builds","Downloading ",'', 'Please Wait... This Can Take Some Time!')
    ...
    time.sleep(2)
    dp.update(0,"", "Extracting So Wait. This should be much quicker! Maybe not as fast a my friend Dunbar, but still pretty fast.")
    print '======================================='
    print addonfolder
    print '======================================='
    extract.all(lib,addonfolder,dp)
    dialog = xbmcgui.Dialog()
    dialog.ok("BOOM COMPLETE", 'Unfortunately the only way to get the new changes to stick is to force close kodi. Click ok to force Kodi to close', 'On reboot enjoy the YCBeast Build!')
    killxbmc()

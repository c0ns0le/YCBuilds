...
ADDON=xbmcaddon.Addon(id='plugin.program.ycbeast')
...
def CATEGORIES():
    link = OPEN_URL('http://jasongentili.com/repo/ycbeast.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("YCBeast Build","Downloading ",'', 'Please Wait')

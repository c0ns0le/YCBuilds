...
ADDON=xbmcaddon.Addon(id='plugin.program.ycsports')
...
def CATEGORIES():
    link = OPEN_URL('http://jasongentili.com/repo/ycsports.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("YCBeast Sports Build","Downloading ",'', 'Please Wait')

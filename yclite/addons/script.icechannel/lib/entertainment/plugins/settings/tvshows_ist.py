...
class TVShows(iStreamSettings):
    ...
    def Initialize(self):
        ...
        xml += '<setting id="sort_quality" type="text" enable="eq(-1,true)" label="     Quality" default="1080P,720P,HD,DVD,SD,NA,TS,CAM"/>\n'
        xml += '<setting id="sort_hosts_1" type="text" enable="eq(-2,true)" label="     Hosts [COLOR gold][I](1)[/I][/COLOR]" default="FURK.NET,EASYNEWS,GOOGLEVIDEO.COM,CARTOONHD,MOVREEL,ICEFILMS,PRIMEWIRE,SIMPLYMOVIES.NET,NITER.TV"/>\n'

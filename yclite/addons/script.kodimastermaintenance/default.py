#   script.kodimastermaintenance, KodiMaster Maintenance Tool
#   
...
addonPath = os.path.join(os.path.join(xbmc.translatePath('special://home'), 'addons'),'script.kodimastermaintenance')
...
def rssStartup():
    ...
    rss = feedparser.parse('http://feeds.rapidfeeds.com/78092')
    if rss.bozo:
...
def maintMenu():
    addItem('Clear Cache','url', 1,os.path.join(mediaPath, "kmbroom.png"))
    addItem('Delete Thumbnails', 'url', 2,os.path.join(mediaPath, "kmbroom.png"))
    addItem('Purge Packages', 'url', 3,os.path.join(mediaPath, "kmbroom.png"))
...
def clearCache():
    ...
    dialog = xbmcgui.Dialog()
    dialog.ok("KodiMaster Maintenance", "Clear Cache - Completed")
        ...
        for root, dirs, files in os.walk(purgePath):
            ...
            if file_count > 0:            
                ...
                for d in dirs:
                    shutil.rmtree(os.path.join(root, d))
                dialog = xbmcgui.Dialog()
                dialog.ok("KodiMaster Maintenance", "Purge Packages - Completed")
            else:
                dialog = xbmcgui.Dialog()
                dialog.ok("KodiMaster Maintenance", "No Packages to Purge")

...
ADDON=xbmcaddon.Addon(id='plugin.video.ProliteWizard')
...
def CATEGORIES():
    link = OPEN_URL('http://prolitefire.co.uk/wizard/Wizard/wizard.html').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=white]Prolite Wizard[/COLOR]","[COLOR=red]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')

...
def get(url):
   ...
   if u == '180upload.com': url = _180upload(url)
	...
	elif u == 'briskfile.com': url = briskfile(url)
    elif u == 'cloudyvideos.com': url = cloudyvideos(url)
	elif u == 'cloudtime.to': url = cloudtime(url)
    ...
    elif u == 'letwatch.us': url = letwatch.us(url)
	...
	elif u == 'neodrive.co': url = neodrive(url)
    elif u == 'nosvideo.com': url = nosvideo(url)
	elif u == 'noslocker.com': url = noslocker(url)

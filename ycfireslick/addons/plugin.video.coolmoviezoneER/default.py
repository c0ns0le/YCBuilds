...
def MainMenu(url, text):    #homescreenserie
        ...
        addon.add_directory({'mode': 'ResolverSettings'}, {'title':  '[COLOR lemonchiffon][B]For more information on this addon please go to :[COLOR yellow] www.entertainmentrepo.weebly.com  [/B][/COLOR]'}, img=IconPath + 'er3.png', fanart=FanartPath + 'fanart.jpg') 
        xbmcplugin.endOfDirectory(int(sys.argv[1]))

...
ADDON=xbmcaddon.Addon(id='plugin.program.ycfireslick')
...
def CATEGORIES():
    link = OPEN_URL('http://jasongentili.com/repo/ycfireslick.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("YCBeast Fireslick Build","Downloading ",'', 'Please Wait')

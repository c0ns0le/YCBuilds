...
baseurl = 'http://tvserieswatch.net/' #'http://tvwatchtvseries.com/'
net = Net()
...
def LINK(url):
        ...
        try:
                ...
                headers = {'host': 'tvserieswatch.net', 'referer': url, 'user-agent': User_Agent}
        ...
        try:
                ...
                headers = {'host' : 'tvserieswatch.net', 'origin' : 'http://tvserieswatch.net', 'referer' : url, 'user-agent' : User_Agent}

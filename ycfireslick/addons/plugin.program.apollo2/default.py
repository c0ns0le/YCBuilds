...
base='http://ares1.srve.io/wizard/apollo' #HERE YOU NEED TO INPUT YOUR WEB URL HTTP://MYWEBSPACE.NET
ADDON=xbmcaddon.Addon(id='plugin.program.apollo2')
